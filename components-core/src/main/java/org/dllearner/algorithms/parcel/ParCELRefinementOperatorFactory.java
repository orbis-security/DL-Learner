...
public class ParCELRefinementOperatorFactory extends BasePooledObjectFactory<RefinementOperator> {
    ...
    public RefinementOperator create() throws Exception {
        ...
        refinementOperator.setUseDataHasValueConstructor(this.useHasData); // false
        refinementOperator.setUseHasValueConstructor(this.useHasValue);
        refinementOperator.setCardinalityLimit(this.cardinalityLimit);
        refinementOperator.setMaxNrOfSplits(maxNoOfSplits);
        refinementOperator.setCardinalityLimit(cardinalityLimit);
        refinementOperator.setUseCardinalityRestrictions(useCardinalityRestrictions);
