...
public class ParCELPosNegLP extends AbstractClassExpressionLearningProblem<ParCELScore> {
	...
	protected Set<OWLIndividual> testPositiveExamples;
	protected Set<OWLIndividual> testNegativeExamples;
	...
	public Double TestEvaluation(TreeSet<ParCELExtraNode> definitions, boolean print) {
		...
		for(OWLIndividual example : testPositiveExamples)
		{
			...
			{
				if(reasoner.hasType(def.getDescription(), example))
				{
					matches += 1;
				}
			}
		...
		for(OWLIndividual example : testPositiveExamples)
		{
			...
			if(testing.size() == definitions.size())
			{
	...
	public void setTestPositiveExamples(Set<OWLIndividual> testPositiveExamples) {
		this.testPositiveExamples = testPositiveExamples;
	}

	public void setTestNegativeExamples(Set<OWLIndividual> testNegativeExamples) {
		this.testNegativeExamples = testNegativeExamples;
	}

	public Set<OWLIndividual> getTestPositiveExamples() {
		return this.testPositiveExamples;
	}

	public Set<OWLIndividual> getTestNegativeExamples() {
		return this.testNegativeExamples;
	}
}
